      ...
      <nav className="flex-1 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
        <div className="px-3 space-y-0.5 pb-4 pt-2">
          ...
          <Link
            ...
            className={`flex items-center px-4 py-3 transition-colors relative rounded-lg ${isActive('/payment-details')
              ? 'bg-brand-500 text-dark-base'
              : 'text-gray-700 hover:bg-brand-50 hover:text-brand-900'
              }`}
            style={{}}
          >
            ...
            <span className="text-sm font-normal">Payment Details</span>
          </Link>
          ...
          <div>
            <button
              ...
              className={`w-full flex items-center justify-between px-4 py-3 transition-colors relative rounded-lg ${isActive('/trade-performance')
                ? 'bg-brand-500 text-dark-base'
                : 'text-gray-700 hover:bg-brand-50 hover:text-brand-900'
                }`}
              style={{}}
            >
              <div className="flex items-center">
                ...
                <span className="text-sm font-normal">Trade Performance</span>
              </div>
              <svg
