      ...
      <nav className="flex-1 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 200px)' }}>
        <div className="px-3 space-y-0.5 pb-4 pt-2">
          ...
          <div>
            ...
            >
              <div className="flex items-center">
                <div className="relative w-5 h-5 mr-3 flex-shrink-0">
                  <svg className="w-4 h-4 absolute bottom-0 left-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                  </svg>
                  <svg className="w-5 h-5 absolute top-0 right-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            ...
            <span className="text-sm font-normal">Refer a Friend</span>
          </Link>
        </div>
      </nav>
    </div>
