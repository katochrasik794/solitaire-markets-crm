...
function ReferAFriend() {
  ...
  return (
    <div className="bg-gray-50 min-h-screen overflow-x-hidden">
      {/* Top Banner Section */}
      <div className="bg-gradient-to-r from-gray-800 to-gray-600 rounded-lg text-white" style={{ width: '1100px', height: '230px', margin: '0 auto' }}>
        <div className="w-full h-full px-4 py-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 items-center h-full">
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold mb-2" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '24px', fontWeight: '700' }}>
                Refer Friends. Earn Rewards. Trade. Repeat.
              </h1>
              <p className="text-base mb-4 opacity-90" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '14px', fontWeight: '400' }}>
              ...
              <div className="mb-3">
                <div className="flex flex-col sm:flex-row gap-2 mb-2">
                  <input
                    ...
                    readOnly
                    value={referralLink}
                    className="flex-1 px-3 py-2 bg-white text-gray-800 rounded-lg border border-gray-300"
                    style={{ fontFamily: 'Roboto, sans-serif', fontSize: '12px' }}
                  />
                  <button
                    onClick={copyToClipboard}
                    className="px-4 py-2 bg-white text-blue-900 font-semibold rounded-lg hover:bg-gray-100 transition-colors whitespace-nowrap"
                ...
                <div className="flex items-center gap-2 mb-2">
                  <button className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-colors">
                    <span className="text-white font-bold" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '14px', fontWeight: '700' }}>f</span>
                  </button>
                  <button className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-colors">
                    <span className="text-white font-bold" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '14px', fontWeight: '700' }}>X</span>
                  </button>
                  <button className="w-8 h-8 bg-white bg-opacity-20 rounded-full flex items-center justify-center hover:bg-opacity-30 transition-colors">
                ...
                <p className="text-xs opacity-80" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '10px', fontWeight: '400' }}>
            ...
            <div className="flex flex-col items-end justify-center gap-4 pr-4">
              {/* How it works Button */}
              <button className="px-8 py-3 bg-teal-500 hover:bg-teal-600 text-white font-semibold rounded-lg transition-colors w-48" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px', fontWeight: '600' }}>
                How it works
              </button>
              ...
              <div className="flex items-center gap-4">
                ...
                {/* Download Button */}
                <button className="px-6 py-3 bg-white text-gray-700 font-semibold rounded-lg hover:bg-gray-100 transition-colors" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '14px', fontWeight: '600' }}>
                  Download
                </button>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto p-4 sm:p-6">
        ...
        <div className="bg-white rounded-lg shadow-md p-6 mb-6 border border-gray-200">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
            <h2 className="text-xl font-bold mb-4 sm:mb-0" style={{ fontFamily: 'Roboto, sans-serif', fontSize: '20px', color: '#000000', fontWeight: '700' }}>
              Referral Summary
            </h2>
