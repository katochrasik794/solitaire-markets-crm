  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6">
      <div className="max-w-2xl">
        ...
        <button className="w-full bg-purple-600 text-white py-4 rounded-lg flex items-center justify-center hover:bg-purple-700 transition-colors">
          <svg className="w-6 h-6 mr-2 text-white" viewBox="0 0 24 24" fill="currentColor">
            <path d="M11.944 17.97L4.58 13.62 11.943 24l7.37-10.38-7.372 4.35h.003zM12.056 0L4.69 12.223l7.365 4.354 7.365-4.35L12.056 0z"/>
          </svg>
          <span style={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px', fontWeight: '400' }}>Continue with Ethereum</span>
        </button>
      </div>
    </div>
  )
