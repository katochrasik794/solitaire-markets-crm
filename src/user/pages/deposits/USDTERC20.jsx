  ...
  return (
    <div className="bg-gray-50 min-h-screen p-4 sm:p-6">
      <div className="max-w-2xl">
        ...
        <button className="w-full bg-green-600 text-white py-4 rounded-lg flex items-center justify-center hover:bg-green-700 transition-colors">
          <img src="/tether.svg" alt="Tether" className="w-6 h-6 mr-2" />
          <span style={{ fontFamily: 'Roboto, sans-serif', fontSize: '16px', fontWeight: '400' }}>Continue with USDT:ERC20</span>
        </button>
      </div>
    </div>
  )
