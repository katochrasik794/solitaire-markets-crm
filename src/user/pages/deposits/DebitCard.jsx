...
function DebitCard() {
  ...
  >
    Deposit Using Your Debit or Credit Card
        ...
        {/* CARD BUTTON (CENTERED FULL WIDTH) */}
        <div className="flex justify-center"  >
        <button className="max-w-4xl w-full bg-white border-2 border-gray-300 text-gray-800 py-4 rounded-lg flex items-center justify-center hover:bg-gray-50 transition-all">
